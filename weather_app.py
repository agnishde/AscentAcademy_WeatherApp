...
st.set_page_config(page_title='weather_app', page_icon=":cloud:")
...
st.markdown(
    ...
    .reportview-container {
        background: url("https://th.bing.com/th/id/OIP.Ek3jfK2KkmttezCuNzwCcwHaDt?pid=ImgDet&rs=1")
    }
